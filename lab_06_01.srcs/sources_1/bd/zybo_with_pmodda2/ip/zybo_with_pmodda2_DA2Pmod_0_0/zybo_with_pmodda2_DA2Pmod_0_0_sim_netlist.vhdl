...
-- Date        : Tue Oct 20 20:16:45 2020
-- Host        : DESKTOP-7QAIPHN running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Zynq_Book/lab_06_01/lab_06_01.srcs/sources_1/bd/zybo_with_pmodda2/ip/zybo_with_pmodda2_DA2Pmod_0_0/zybo_with_pmodda2_DA2Pmod_0_0_sim_netlist.vhdl
-- Design      : zybo_with_pmodda2_DA2Pmod_0_0
...
entity zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0_S00_AXI is
  port (
    DA2dat1 : out STD_LOGIC;
    DA2dat2 : out STD_LOGIC;
    ...
    DA2sync : out STD_LOGIC;
    DA2sclk : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0_S00_AXI : entity is "DA2Pmod_v1_0_S00_AXI";
end zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0_S00_AXI;

architecture STRUCTURE of zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0_S00_AXI is
  signal \DA2Areg_reg_n_0_[0]\ : STD_LOGIC;
  signal DA2Breg : STD_LOGIC_VECTOR ( 11 downto 0 );
  signal DA2acq : STD_LOGIC;
  signal \^da2dat1\ : STD_LOGIC;
  signal \^da2dat2\ : STD_LOGIC;
  signal DA2dav0 : STD_LOGIC;
  signal DA2dt1 : STD_LOGIC;
  signal DA2dt2 : STD_LOGIC;
  signal DA2sck_i_1_n_0 : STD_LOGIC;
  signal DA2sck_i_2_n_0 : STD_LOGIC;
  signal \^da2sclk\ : STD_LOGIC;
  signal DA2syn_i_1_n_0 : STD_LOGIC;
  signal DA2syn_i_2_n_0 : STD_LOGIC;
  signal \^da2sync\ : STD_LOGIC;
  ...
  signal dacstate : STD_LOGIC_VECTOR ( 5 downto 1 );
  signal \dacstate[0]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate[1]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate[2]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate[3]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate[4]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate[5]_i_1_n_0\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[0]\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[1]\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[2]\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[3]\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[4]\ : STD_LOGIC;
  signal \dacstate_reg_n_0_[5]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of DA2dav_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of DA2syn_i_2 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \dacstate[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \dacstate[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \dacstate[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \dacstate[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \g0_b0_i_1__1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of g0_b0_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of g0_b0_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of g0_b0_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of g0_b0_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of g0_b0_i_6 : label is "soft_lutpair8";
...
\DA2Areg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(0),
...
\DA2Areg_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(10),
...
\DA2Areg_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(11),
...
\DA2Areg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(1),
...
\DA2Areg_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(2),
...
\DA2Areg_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(3),
...
\DA2Areg_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(4),
...
\DA2Areg_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(5),
...
\DA2Areg_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(6),
...
\DA2Areg_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(7),
...
\DA2Areg_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(8),
...
\DA2Areg_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg2(9),
...
\DA2Breg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(0),
...
\DA2Breg_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(10),
...
\DA2Breg_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(11),
...
\DA2Breg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(1),
...
\DA2Breg_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(2),
...
\DA2Breg_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(3),
...
\DA2Breg_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(4),
...
\DA2Breg_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(5),
...
\DA2Breg_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(6),
...
\DA2Breg_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(7),
...
\DA2Breg_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(8),
...
\DA2Breg_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg3(9),
...
DA2acq_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => slv_reg0(0),
...
DA2dav_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8888888"
    )
        port map (
...
DA2dav_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
DA2dt1_reg: unisim.vcomponents.FDRE
     port map (
      C => DA2clk,
      CE => '1',
      D => \g0_b0__1_n_0\,
...
DA2dt2_reg: unisim.vcomponents.FDRE
     port map (
      C => DA2clk,
      CE => '1',
      D => \g0_b0__2_n_0\,
...
DA2sck_i_1: unisim.vcomponents.LUT6
    generic map(
...
DA2sck_i_2: unisim.vcomponents.LUT6
    generic map(
...
DA2sck_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
DA2syn_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF7FF0000C40C"
    )
        port map (
      I0 => DA2acq,
      I1 => DA2syn_i_2_n_0,
...
DA2syn_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
DA2syn_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\dacstate[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B800"
    )
        port map (
...
\dacstate_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dacstate_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dacstate_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dacstate_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dacstate_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dacstate_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0 is
  port (
    DA2dat1 : out STD_LOGIC;
    DA2dat2 : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0 : entity is "DA2Pmod_v1_0";
end zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0;

architecture STRUCTURE of zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0 is
begin
DA2Pmod_v1_0_S00_AXI_inst: entity work.zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0_S00_AXI
     port map (
      DA2clk => DA2clk,
      DA2dat1 => DA2dat1,
      DA2dat2 => DA2dat2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zybo_with_pmodda2_DA2Pmod_0_0 is
  port (
    DA2sync : out STD_LOGIC;
    DA2dat1 : out STD_LOGIC;
    DA2dat2 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of zybo_with_pmodda2_DA2Pmod_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zybo_with_pmodda2_DA2Pmod_0_0 : entity is "zybo_with_pmodda2_DA2Pmod_0_0,DA2Pmod_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zybo_with_pmodda2_DA2Pmod_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of zybo_with_pmodda2_DA2Pmod_0_0 : entity is "DA2Pmod_v1_0,Vivado 2019.1";
end zybo_with_pmodda2_DA2Pmod_0_0;

architecture STRUCTURE of zybo_with_pmodda2_DA2Pmod_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 S00_AXI_CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN zybo_with_pmodda2_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
inst: entity work.zybo_with_pmodda2_DA2Pmod_0_0_DA2Pmod_v1_0
     port map (
      DA2clk => DA2clk,
      DA2dat1 => DA2dat1,
      DA2dat2 => DA2dat2,
