...
HD_PWD='C:/Zynq_Book/lab_06_01/lab_06_01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_with_pmodda2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_with_pmodda2_wrapper.tcl -notrace
