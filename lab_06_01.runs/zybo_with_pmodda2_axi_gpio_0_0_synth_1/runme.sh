...
HD_PWD='C:/Zynq_Book/lab_06_01/lab_06_01.runs/zybo_with_pmodda2_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_with_pmodda2_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_with_pmodda2_axi_gpio_0_0.tcl
